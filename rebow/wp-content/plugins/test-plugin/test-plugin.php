...
function test_init(){
    ...
    echo "<div><h1>Packages </h1>&nbsp;&nbsp;<a href='$url'>Add New Package</a></div><br/>";
...
function show_products(){
	...
	echo "<tr><th >Product Name</th><th >Product Type</th><th >Box Count</th><th >Rental Packages</th><th >Storage Packages</th><th></th></tr>";
	while($row = mysql_fetch_array($result)){
		...
		echo "<td><a href='edit_packages.php?product=$product_id'>Edit Package</a></td>";
		echo '</tr>';
		echo '</form>';
	}
	echo "</table>";
