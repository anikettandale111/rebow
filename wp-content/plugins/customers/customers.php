...
function test_plugin_customers_menu(){
    add_menu_page( 'Customers Page', 'Customers', 'manage_options', 'Customers', 'test_init_customer','dashicons-groups' );
}
...
function show_customers_data(){
	...
	echo "<table id='example' class='display testexample' width='100%'><thead>
			<tr><th>Sr.No. </th><th >Customer Name</th><th >Email ID</th><th >phone_number</th><th>Action</th></tr></thead>";
	echo "<tbody>";
	$count = 1; 
	while($row=mysql_fetch_assoc($res)){
		...
		<tr>
			...
			<?php echo "<td><a href='user-edit.php?user_id=$user_id' class='user_info_edit button button-primary'>EDIT</a></td>";?>
		</tr>
