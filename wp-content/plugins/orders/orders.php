...
function test_plugin_orders_menu(){
    ...
    $menu = add_menu_page( 'Orders Page', 'Order', 'manage_options', 'Orders', 'test_init_order','dashicons-cart' );
...
function show_orders(){
	...
	echo "<tr><th>Order ID</th><th>User Name</th><th>Date</th><th>Status</th><th>Total</th></tr></thead>";
	echo "<tbody>";
