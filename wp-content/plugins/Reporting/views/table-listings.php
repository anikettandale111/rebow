<?php
	...
	class OWTListTableClass extends WP_List_Table{
		...
		public function prepare_items(){
			...
			if(count($datas)){
				$count =1;
				$html .= "<table id='example' class='display testexample' width='100%'>";
				$html .= "<thead><tr><th>Sr.No.</th><th>Order ID</th><th>Customer</th><th>Date</th><th>Status</th><th>Delivery Address</th><th>Pickup Address</th><th>Box Count</th></tr></thead><tbody>";
	...
	<script>
		...
		jQuery( "#example_length" ).after( "<div id='custome_filter'></div>" );
	</script>