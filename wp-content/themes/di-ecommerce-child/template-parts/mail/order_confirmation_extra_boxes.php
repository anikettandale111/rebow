...
<style type="text/css">
	*{margin: 0; padding: 0; border: 0;}
	...
	.p-info ul li{background: url('http://40.71.206.180/rebow/wp-content/themes/di-ecommerce-child/assets/images/tick-icon.svg') no-repeat 0 0; list-style: none; padding-left: 30px; font-size: 15px; font-family: 'axiformabook'; color: #3B3B3B;}
	.product-img{width: 60%; margin:0 auto; padding-top: 70px;}
	.ord-details p{color: #737373; font-family: 'axiformamedium'; font-size: 15px;}
	.card-charge{ padding: 20px 30px; text-align: center; border-top: 1px solid #979797; float: left;}
	.card-charge p{ font-family: 'axiformabook'; font-size: 15px; color: #4D4D4D; }
		...
		<div class="email-container">
			...
			<div class="grey-bg">
				<div class="p-img text-center">
					<img class="product-img" src="http://40.71.206.180/rebow/wp-content/themes/di-ecommerce-child/assets/images/group-of-dollies.png" alt="" style="">
				</div>
				<div class="p-info">
					<div class="col ord-details">
						<p>added_box_count ReBow Boxes</p>
						<p>$subtotal / order_time_period</p>
					</div>
					<div class="col">
						<p>Every 4 Boxes includes : </p>
						<ul>
							<li>1 Nestable ReBow™ Dolly</li>
							<li>4 Labels</li>
							<li>4 Security Zip Ties</li>
						</ul>
					</div>
				...
				<div class="card-charge">
					<p>Your card ending in card_ending will be charged $total_price once you receive your ReBow order on order_completion_date.</p>
				</div>
			</div>
