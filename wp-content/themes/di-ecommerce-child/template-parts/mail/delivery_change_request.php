...
<style type="text/css">
	*{margin: 0; padding: 0; border: 0;}
	body{font-family: 'axiformaregular'; font-size: 14px; max-width: 600px; margin: 0 auto; padding: 2%; color: #434343;letter-spacing: 1px;}
	...
	p{letter-spacing: 1.3px; line-height: 25px; color: #434343;}
	...
	.email-cnfrm p{font-family: 'axiformabook'; font-size: 14px;}
...
<body>
	<div class="wrapper">
		...
		<div class="email-container">
			<div class="col">
				<h1>Delivery Date Change Request</h1>
			</div>
			<div class="col text-center email-cnfrm">
				<p>This email confirms the changes you have requested for <a class="link" href="javascript:;"> order # order_id</a>. We will confirm these times with you within<br> 24-48 hours. </p>
			</div>
