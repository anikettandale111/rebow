...
<style type="text/css">
	*{margin: 0; padding: 0; border: 0;}
	...
	.col{padding-bottom: 20px; float: left; width: 100%;}
	...
	.card-charge p{ font-family: 'axiformabook'; font-size: 15px; color: #434343; }
	...
	.italic{font-family: 'axiformabook'; font-size: 12px; margin-top: 30px; color: #434343;}
	.rnt-prd, .rnt-prd p{color: #737373; font-family: 'axiformamedium';}
	.rnt-prd p{margin-top: -2px;}
		...
		<div class="email-container">
			...
			<div class="grey-bg">
				...
				<div class="card-charge">
					<p>Your card ending in card_ending will be charged $total_price monthly 48 hours after you receive your ReBow order on order_completion_date</p>
				</div>
			</div>
			<div class="col italic">
				<p><em>Your monthly storage dues will be due on the 2nd of every month and we will charge the card on file ending in card_ending.</em></p>
			</div>
			<div class="col dnt-reply text-center">
