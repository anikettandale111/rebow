...
<style type="text/css">
	...
	*{margin: 0; padding: 0; border: 0;}
	...
	.footer ul li{float:left ;margin-right: 30px; list-style: none;}
...
<body>
	<div class="wrapper">
		...
		<div class="email-container">
			...
			<div class="grey-bg min-w mb">
				<div class="col pb-0">
					<label for=""><strong>Log in  :</strong></label>
					<p>name1</p>
				</div>
				<div class="col pb-0">
			...
			<div class="clear"></div>
				<div class="col">
					<p>If you have trouble logging in, or accessing your account. Please call us at 323.277.1111 or email us at <br/>info@rebowsystem.com</p>
				</div>
				<div class="col">
